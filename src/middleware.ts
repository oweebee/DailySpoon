...
// - /api/internal/vpn-config : lu par le conteneur morss intégré au
//   démarrage (morss/entrypoint.sh), qui n'a pas non plus de cookie de
//   session — même mécanisme CRON_SECRET que /api/cron/generate.
const PUBLIC_PATHS = [
  "/admin/login",
  "/api/admin/login",
  "/api/cron/generate",
  "/api/greader.php",
  "/api/internal/vpn-config"
];
