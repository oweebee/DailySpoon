...
export function ArticleImage({
  ...
  return (
    <div className={`relative ${className || ""}`}>
      ...
      {dateLabel && (
        <span
          className="pointer-events-none absolute bottom-2 right-2 rotate-[-9deg] select-none border-2 border-journal px-1.5 py-0.5 font-mono text-[0.6rem] uppercase tracking-wider text-journal opacity-80 mix-blend-multiply"
          aria-hidden="true"
        >
          {dateLabel}
        </span>
