// User-Agent de navigateur classique, réutilisé PARTOUT où ce code fait un
// fetch serveur-à-serveur vers un site tiers (article-proxy, customFeeds,
// freshrss og:image, reddit, image/video-proxy...) : de nombreux sites (ex.
// jeuxvideo.com) renvoient un 403 dès qu'ils reconnaissent un User-Agent
// "bot" dans l'en-tête, même pour une requête anodine — un User-Agent de
// navigateur classique passe sans problème. Centralisé ici (au lieu d'être
// recopié tel quel dans chaque fichier) pour n'avoir qu'un seul endroit à
// mettre à jour si la version Chrome affichée doit changer un jour.
